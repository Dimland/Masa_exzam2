...
const getWithDoubleTimeoutChained = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const getWithDoubleTimeoutParallel = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const getWithDelayValidated = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export default {
  ...
  getWithDelay,
  getWithDelayAsync,
  getWithDelayValidated,
  getWithDoubleTimeout,
  getWithDoubleTimeoutChained,
  getWithDoubleTimeoutParallel,
};

...
const getBoardTypeById = async (
  ...
  if (typeof numericParamOrError === "number") {
    if (numericParamOrError > 0) {
      schoolService
        .getBoardTypeById(numericParamOrError)
        .then((result: whiteBoardType) => {
...
const updateBoardTypeById = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const addBoardTypeByStoredProcedure = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const addBoardTypeByStoredProcedureOutput = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  schoolService
    .addBoardTypeByStoredProcedureOutput(
      {
        id: NON_EXISTENT_ID,
        type: body.type,
      },
...
const deleteBoardTypeById = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
const getBoardTypeByTitle = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
